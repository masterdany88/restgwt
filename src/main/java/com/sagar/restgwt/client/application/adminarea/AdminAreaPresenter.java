...
package com.sagar.restgwt.client.application.adminarea;
...
import com.sagar.restgwt.client.application.ApplicationPresenter;
...
public class AdminAreaPresenter extends Presenter<AdminAreaPresenter.MyView, AdminAreaPresenter.MyProxy> {
    ...
    AdminAreaPresenter(
            ...
            MyView view,
            MyProxy proxy) {
        super(eventBus, view, proxy, ApplicationPresenter.SLOT_TAB_CONTENT);
    }
